...
public class ObjectOperations implements Serializable {
	...
	public ObjectOperations() {
		...
		dropDownObjectTypes.put("Core Business Object (Default)",
		 ...
		 //Initialize Existing Business Objects created from the Database 
		businessObjects = readObject();
	 ...
	 * Method: readObject
	 * 
	 * Purpose: This method takes care of reading a business objects to current
	 * list check if a business object with same name already exist
	 * 
	 * Attributes: objectName - this is the attribute which contains business
	 * object name as provided by user from front end
	 ...
	 * 
	 ****************************************************************************/
	public ArrayList<BusinessObject> readObject() {
		ArrayList<BusinessObject> readData = null;				
		String query = "select * from business_objects";
	   
		DatabaseOperations operations = new DatabaseOperations();
	   readData= operations.readBusinessObjectData(query);
	   return readData;
	}	
